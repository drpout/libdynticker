...
public class BanxExchangeTest extends ExchangeTest {
	@Override
	@Before
	public void setUp() throws Exception {
		testExchange = new BanxExchange(10000);
	}
	...
	public void testParseJson() {
		try {
			...
			JsonNode node = (new ObjectMapper().readTree(new File("src/test/json/banx-ticker.json")));
			String lastValue = testExchange.parseJSON(node, pair);
			Assert.assertEquals("0.00670013", lastValue);
		} catch (IOException e) {
			Assert.fail();
		}
	}
